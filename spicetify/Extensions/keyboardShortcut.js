...
(function KeyboardShortcut() {
	...
	const binds = {
		...
		// L Next and H Previous Song
		"h": { callback: () => Spicetify.Player.back() },
		"l": { callback: () => Spicetify.Player.next() },

		// Arrow Up Increase Volume Arrow Down Decrease Volume
		"up": { callback: () => Spicetify.Player.setVolume(Spicetify.Player.getVolume() + 0.05) },
		"down": { callback: () => Spicetify.Player.setVolume(Spicetify.Player.getVolume() - 0.05) },
